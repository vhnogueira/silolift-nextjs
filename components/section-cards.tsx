  ...
  return (
    <div className="*:data-[slot=card]:from-primary/5 *:data-[slot=card]:to-card dark:*:data-[slot=card]:bg-card grid grid-cols-1 gap-4 px-4 *:data-[slot=card]:bg-gradient-to-t *:data-[slot=card]:shadow-xs lg:px-6 @xl/main:grid-cols-2 @5xl/main:grid-cols-2">
      <Card className="@container/card">
        <CardHeader>
          <CardDescription>Pages sent to ChatGPT</CardDescription>
      ...
      <Card className="@container/card">
        <CardHeader>
          <CardDescription>ChatGPT Progress</CardDescription>
          <CardTitle className="text-2xl font-semibold tabular-nums @[250px]/card:text-3xl">
            60%
          </CardTitle>
          {/* <CardAction>
        ...
        <CardFooter className="flex-col items-start gap-1.5 text-sm">
          <div className="line-clamp-1 flex gap-2 font-medium">
            30 of 50 pages rewritten
          </div>
          <div className="text-muted-foreground">
            estimated time to finish: 5 hours left
          </div>
        </CardFooter>
      </Card>
      {/* <Card className="@container/card">
